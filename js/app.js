...
{ text: "Если крикнуть на стакан воды, он закипит быстрее", isTrue: false, argument: "Звуковые волны не способны существенно нагреть воду." },
...
{ text: "В Антарктиде есть озеро, которое не замерзает при -50°C", isTrue: true, argument: "Озеро Дон-Жуан настолько солёное, что остаётся жидким даже в лютый мороз." },
...
{ text: "Магнитное поле Земли переворачивается раз в миллион лет", isTrue: true, argument: "За историю планеты северный и южный магнитные полюса менялись местами сотни раз." },
...
{ text: "Если громко кричать на лук во время готовки, слёз будет меньше", isTrue: false, argument: "Шутка! Слёзы вызывает химическое вещество, а не страх лука перед вами." },
{ text: "В Антарктиде есть единственная в мире банкоматная очередь из пингвинов", isTrue: false, argument: "Пингвины там есть, но банкоматов и очередей они не устраивают." },
{ text: "Человеческий нос различает более триллиона запахов", isTrue: true, argument: "Это правда, но почему-то мы всё равно не чувствуем, когда скисает молоко." },
...
{ text: "Молния может поджарить тост, но не сделает его хрустящим", isTrue: false, argument: "Скорее испепелит, но шутка про идеальный завтрак." },
{ text: "У некоторых людей есть ген, позволяющий есть кинзу без мыла во рту", isTrue: true, argument: "У остальных генетическая неприязнь, и они страдают." },
{ text: "Если все люди на Земле одновременно прыгнут, планета сдвинется на миллиметр", isTrue: false, argument: "Масса слишком мала, чтобы сдвинуть Землю, но звук был бы эпичным." },
{ text: "Сахар не растворяется в бензине, но зато в нём можно хранить секреты", isTrue: false, argument: "Шутка про конспирологов, но технически сахар не растворим в бензине." }
  ],
  "История": [
    ...
    { text: "Древний Рим пал из-за отравления свинцом", isTrue: false, argument: "Свинцовые трубы могли влиять на здоровье, но не были главной причиной краха." },
{ text: "Петр I запретил носить бороды под страхом штрафа", isTrue: true, argument: "В 1698 году ввёл налог на бороды для всех, кроме духовенства." },
{ text: "Первая мировая война закончилась ровно в 11 часов 11 дня 11 месяца", isTrue: true, argument: "Перемирие вступило в силу 11 ноября 1918 года в 11:00." },
{ text: "Чингисхан изобрёл гамбургер", isTrue: false, argument: "Шутка! Монгольские воины клали мясо под седло, но это не бургер." },
{ text: "В Древнем Египте кошек мумифицировали чаще, чем людей", isTrue: true, argument: "Найдены миллионы кошачьих мумий, кошки были священными." },
{ text: "Королева Виктория разговаривала с акцентом кокни", isTrue: false, argument: "Она говорила на правильном королевском английском." },
...
{ text: "Средневековые рыцари приветствовали друг друга, поднимая забрало – так появился жест «козыряния»", isTrue: true, argument: "Одна из версий происхождения воинского приветствия." },
...
{ text: "Динозавры вымерли из-за того, что не смогли пережить моду на маленькие руки", isTrue: false, argument: "Ироничная шутка про тираннозавра. На самом деле — падение астероида." },
...
{ text: "Наполеон проиграл битву при Ватерлоо из-за того, что у него чесалась спина", isTrue: false, argument: "Причина была в тактике и погоде, а не в зуде." },
{ text: "Средневековые туалеты назывались «гардеробами», потому что в них хранили одежду", isTrue: true, argument: "Запах отпугивал моль, но, наверное, и гостей." },
{ text: "Чингисхан запретил своим воинам стирать одежду, чтобы не тратить воду", isTrue: true, argument: "Гигиена была не в приоритете, зато экология." },
{ text: "Первый будильник мог звонить только в 4 утра", isTrue: true, argument: "Изобретатель, видимо, был жаворонком-экстремистом." },
{ text: "Викинги использовали мочу для разведения огня", isTrue: true, argument: "Смешивали с грибами, и это работало. Запах, наверное, был героический." }
  ],
  "Мемы": [
...
{ text: "Песня 'Never Gonna Give You Up' была написана специально для рикроллинга", isTrue: false, argument: "Песня 1987 года, а рикроллинг появился только в 2007." },
...
{ text: "Картинка 'Успешный ребёнок' с сжатым кулаком — это стоковое фото", isTrue: true, argument: "Знаменитый мем из фотостока." },
{ text: "Мем 'Ждун' создан голландской художницей", isTrue: true, argument: "Скульптура Homunculus loxodontus Маргрит ван Бреворт." },
{ text: "Кот в сапогах из Шрека — это мем про грустные глаза", isTrue: true, argument: "Широко используется как реакция на трогательные моменты." },
{ text: "Эмодзи с улыбающейся какашкой придумали в Японии", isTrue: true, argument: "Иероглиф 'ун' действительно существует и означает удачу." },
{ text: "Мем 'Наташа, ты спишь?' — это отсылка к фильму ужасов", isTrue: false, argument: "Это из популярного вайна, где парень спрашивает девушку." },
{ text: "Существует мем про то, что Шрэк — это любовь, Шрэк — это жизнь", isTrue: true, argument: "Культовый фанатский видео-мем 2014 года." },
{ text: "Собака породы сиба-ину использовалась в криптовалюте Dogecoin", isTrue: true, argument: "Та самая Кабосу стала символом Dogecoin." },
...
{ text: "Кот, который кричит на женщину за столом — это спор о веганстве", isTrue: false, argument: "На самом деле это два разных стоковых фото, но мем именно так интерпретируют." },
{ text: "Все мемы с Лягушонком Пепе запрещены в 40 странах", isTrue: false, argument: "Используется везде, хотя иногда вызывает споры." },
{ text: "Мем 'Я не кот' на самом деле был снят в суде по делу о разводе", isTrue: true, argument: "Адвокат случайно включил фильтр кота на Zoom во время слушания о нарушении ПДД." },
{ text: "Дрейк в меме 'нет/да' на самом деле показывал жесты для глухонемых", isTrue: false, argument: "Он просто танцевал, но мем бессмертен." }
  ],
  "Животные": [
...
{ text: "Совы могут поворачивать голову на 360 градусов", isTrue: false, argument: "На самом деле максимум — 270 градусов." },
{ text: "Змеи моргают, но у них нет век", isTrue: false, argument: "У змей прозрачная сросшаяся чешуя, они не моргают." },
{ text: "Фламинго розового цвета от рождения", isTrue: false, argument: "Они рождаются серыми, а розовый пигмент получают с пищей." },
{ text: "Броненосцы всегда рождают четверых близнецов", isTrue: true, argument: "Из одной оплодотворённой яйцеклетки развиваются четыре идентичных детёныша." },
...
{ text: "Белые медведи не заметны в инфракрасном свете", isTrue: true, argument: "Их шерсть очень хорошо изолирует тепло, поэтому на ИК-камере их почти не видно." },
{ text: "Крокодилы едят камни, чтобы лучше нырять", isTrue: true, argument: "Камни в желудке работают как балласт и помогают переваривать пищу." },
...
{ text: "Выдры держатся за лапки, чтобы не потеряться во сне", isTrue: true, argument: "Это невероятно мило и абсолютная правда." },
{ text: "Пингвины дарят друг другу камни в знак любви", isTrue: true, argument: "Это их брачный ритуал — практически помолвка с булыжником." },
{ text: "Ленивцы могут умереть от голода с полным желудком", isTrue: true, argument: "Если станет холодно, бактерии в их животе перестают работать, и они не переваривают еду." },
{ text: "Козы имеют акцент в зависимости от региона", isTrue: true, argument: "Звучит смешно, но их блеяние различается у разных популяций." },
{ text: "Слоны думают, что люди милые, как мы про щенков", isTrue: true, argument: "Исследования мозга показывают, что при виде людей у слонов активируются зоны, отвечающие за умиление." },
{ text: "Курицы могут бегать без головы несколько минут", isTrue: true, argument: "Особенно знаменитый петух Майк, проживший без головы 18 месяцев." },
{ text: "Воробьи специально дразнят кошек по утрам, чтобы те не спали", isTrue: false, argument: "Это просто совпадение, но выглядит очень правдоподобно." }
  ],
  "Игры": [
    ...
    { text: "Главный герой Doom носит очки", isTrue: false, argument: "Doomguy носит шлем, и его лицо почти не видно." },
{ text: "Симс разработал тот же человек, что и SimCity", isTrue: true, argument: "Уилл Райт придумал обе игры." },
{ text: "В Ведьмаке 3 можно найти пасхальное яйцо с Титаником", isTrue: true, argument: "В локации Скеллиге лежит затонувший корабль, напоминающий Титаник." },
...
{ text: "Марио — это сантехник, но в играх он почти не работает", isTrue: true, argument: "Трубы видит чаще, чем гаечный ключ." },
{ text: "В игре Skyrim можно жениться на вампире", isTrue: true, argument: "Серана — популярный выбор, хотя без модов брак с ней недоступен." },
{ text: "Культовая фраза 'Finish Him!' появилась раньше Mortal Kombat", isTrue: false, argument: "Именно MK популяризировала фразу в файтингах." },
...
{ text: "В игре 'Goat Simulator' баги стали фичами и принесли миллионы", isTrue: true, argument: "Разработчики нарочно оставили безумные глюки, и это прославило игру." },
{ text: "Создатель 'Dark Souls' специально делает игры сложными, потому что сам не может пройти", isTrue: false, argument: "Миядзаки умеет играть, но любит, чтобы страдали все." },
{ text: "В 'Sims' можно устроить вечеринку и умереть от смеха на ней", isTrue: true, argument: "Это классика: гости веселятся, а ты становишься призраком." },
{ text: "Персонаж Марио носит кепку, потому что у него нет времени рисовать волосы", isTrue: true, argument: "Так сказал Сигэру Миямото — кепка упрощала анимацию." }
  ],
  "18+": [
...
{ text: "В Дании существует должность официального дегустатора порнофильмов", isTrue: false, argument: "Такой вакансии официально нет, но были похожие рекламные акции." },
...
{ text: "Оральный секс запрещён в 12 штатах США до сих пор", isTrue: false, argument: "Старые законы есть, но они не действуют после решений Верховного суда." },
{ text: "Размер ноги мужчины не коррелирует с длиной пениса", isTrue: true, argument: "Научные исследования не нашли связи." },
{ text: "Самый дорогой презерватив стоит более 1000 долларов", isTrue: true, argument: "Существуют дизайнерские изделия, но это скорее предмет роскоши." },
...
{ text: "Презервативы из овечьей кишки защищают от ЗППП", isTrue: false, argument: "Они пропускают вирусы, поэтому только от беременности." },
{ text: "Некоторые люди испытывают оргазм от чистки зубов", isTrue: true, argument: "Синдром спонтанной эйфории, хотя крайне редкий." }
{ text: "В Швеции есть конкурс по метанию резиновых сапог на дальность", isTrue: true, argument: "Это не связано с 18+, но почему-то включили в список, потому что смешно." },
{ text: "Самая дорогая подушка для секса стоит как квартира в центре Москвы", isTrue: false, argument: "Преувеличение, но цены на некоторые реалистичные куклы доходят до 10 000 долларов." },
...
{ text: "Существует рекорд по самому массовому одновременному поцелую — более 40 000 человек", isTrue: true, argument: "Было в Мексике в 2009 году, наверное, очень мокро." }
  ]
};
