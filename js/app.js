...
{ text: "Первый контроллер PlayStation был размером с велосипед", isTrue: false, argument: "Шутка! Контроллеры всегда были портативными." },
  ...
  "18+": [
    ...
    { text: "Самый длинный заплыв в истории порноиндустрии длился 30 часов", isTrue: false, argument: "Нет подтверждённых рекордов, это скорее байка." },
    { text: "В Дании существует должность официального дегустатора порнофильмов", isTrue: false, argument: "Такой вакансии официально нет." },
    { text: "Размер ноги мужчины не коррелирует с длиной пениса", isTrue: true, argument: "Научные исследования не нашли связи." },
    { text: "Презервативы из овечьей кишки защищают от ЗППП", isTrue: false, argument: "Они пропускают вирусы, защищают только от беременности." },
    { text: "В Швеции есть конкурс по метанию резиновых сапог на дальность", isTrue: true, argument: "Это не связано с 18+, но забавно." },
    { text: "Однажды в Японии изобрели презерватив со вкусом суши", isTrue: false, argument: "Были ароматизированные, но суши — скорее анекдот." }
  ]
};
